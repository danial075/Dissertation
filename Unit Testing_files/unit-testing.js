...
// Test if the Model correctly validates future dates for traffic data
    ...
    // Test if the map has been intialised
    function testMapInitialisation() {
        view.createMap({}, 'pedestrian');
        logResult("Map should be initialized", view.map !== null);
    }
